"""
Interactive shell commands for Velox framework.
"""
...
def start_shell():
    """Start an interactive shell with Velox framework context."""
    try:
        # Try to import the full framework
        from velox.core.config import get_settings
        from velox.core.application import Velox
        
        settings = get_settings()
        
        console.print("[blue]Starting Velox framework shell...[/blue]")
        console.print("[green]Available objects:[/green]")
        console.print("  - settings: Application settings")
        console.print("  - Velox: Framework application class")
        ...
        try:
            from velox.auth.models import User
            from velox.db.models import Base
...
def run_script(script_path: str):
    """Run a Python script with Velox framework context."""
...
def shell_plus():
    ...
    console.print("[blue]Starting Velox shell plus...[/blue]")
