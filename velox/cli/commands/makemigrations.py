"""
Create database migrations command for Velox CLI.
"""
...
from velox.db.migrations import create_migration_file, CreateTable, AddField
...
from velox.db.migrations import Migration, CreateTable
...
'''.format(datetime.now().isoformat())
            ...
            console.print("[yellow]Run 'velox-admin migrate' to apply the migration[/yellow]")
