"""
Command to create a new Velox app within a project.
"""
...
def create_app(name: str, app_path: Path) -> None:
    """
    Create a new Velox app with standard structure.
...
from velox.http.controllers import APIController, ViewController
...
The preferred way in Velox is to use routes.py.
"""
...
<head>
    <meta charset="utf-8">
    <title>{{{{ title }}}} - Velox Framework</title>
...
<body>
    ...
    <div class="info">
        ...
        <p>This page was generated by the Velox framework.</p>
    </div>
