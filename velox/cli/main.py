"""
Command Line Interface for Velox framework.

This module provides the main CLI entry point and command management
for the Velox framework, similar to Django's manage.py and Laravel's artisan.
"""
...
from velox.core.config import Settings, get_settings
...
app = typer.Typer(
    name="velox-admin",
    help="Velox Framework command line interface",
...
def startproject(
    ...
    This command creates a new Velox project with the standard directory
    structure and configuration files.
    """
    from velox.cli.commands.startproject import create_project
    ...
    try:
        ...
        console.print("  velox-admin runserver")
    except Exception as e:
...
def startapp(
    ...
    """
    from velox.cli.commands.startapp import create_app
...
def runserver(
    ...
    """
    from velox.cli.commands.runserver import run_development_server
...
def shell():
    ...
    """
    from velox.cli.commands.shell import start_shell
...
def makemigrations(
    ...
    """
    from velox.cli.commands.migrations import make_migrations
...
def migrate(
    ...
    """
    from velox.cli.commands.migrations import apply_migrations
...
def test(
    ...
    Run tests.
    """
    from velox.cli.commands.test import run_tests
...
def collectstatic(
    ...
    """
    from velox.cli.commands.collectstatic import collect_static_files
...
def createsuperuser():
    ...
    """
    from velox.cli.commands.createsuperuser import create_superuser
...
def showurls():
    ...
    """
    from velox.cli.commands.showurls import show_urls
...
def generate(
    ...
    """
    from velox.cli.commands.generate import generate_component
...
def version():
    """
    Show Velox framework version information.
    """
    from velox import __version__, framework_info
    
    table = Table(show_header=True, header_style="bold magenta")
    table.add_column("Component", style="cyan")
    table.add_column("Version", style="green")
    
    table.add_row("Velox Framework", __version__)
