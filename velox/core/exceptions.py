"""
Custom exceptions for the Velox framework.

This module defines the exception hierarchy for the Velox framework,
...
class VeloxException(Exception):
    """
    Base exception class for all Velox framework errors.
    
    This is the root exception that all other Velox exceptions inherit from.
...
class DependencyInjectionError(VeloxException):
    """Raised when dependency injection fails."""
    pass


class RouterError(VeloxException):
    """Raised when there's a routing error."""
    pass


class MiddlewareError(VeloxException):
...
class AuthenticationError(VeloxException):
...
class AuthorizationError(VeloxException):
...
class ValidationError(VeloxException):
...
class NotFoundError(VeloxException):
...
class MethodNotAllowedError(VeloxException):
...
class RateLimitError(VeloxException):
...
class FileUploadError(VeloxException):
...
class CacheError(VeloxException):
    """Raised when cache operations fail."""
    pass


class TaskError(VeloxException):
    """Raised when background task processing fails."""
    pass


class WebSocketError(VeloxException):
    """Raised when WebSocket operations fail."""
    pass


class APIError(VeloxException):
    """Raised when API operations fail."""
    pass


class SerializationError(VeloxException):
    """Raised when data serialization/deserialization fails."""
    pass


class ImportError(VeloxException):
    """Raised when module/app imports fail."""
    pass


class AppRegistryError(VeloxException):
    """Raised when app registry operations fail."""
    pass


class PluginError(VeloxException):
    """Raised when plugin operations fail."""
    pass


class MigrationError(VeloxException):
    """Raised when database migration fails."""
    pass


class TestError(VeloxException):
    """Raised when test operations fail."""
    pass


class DeploymentError(VeloxException):
    """Raised when deployment operations fail."""
    pass


class SecurityError(VeloxException):
...
class HTTPError(VeloxException):
...
def handle_exception(exc: Exception) -> Dict[str, Any]:
    ...
    """
    if isinstance(exc, VeloxException):
        return {
