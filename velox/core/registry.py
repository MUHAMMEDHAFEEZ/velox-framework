"""
App registry for managing installed Velox applications.

This module provides functionality for loading, managing, and configuring
Velox applications and plugins.
"""
...
from velox.core.exceptions import VeloxException, AppRegistryError
...
class AppConfig:
    """
    Configuration class for Velox applications.
    
    Each Velox app should define an AppConfig class that inherits from this.
    """
    ...
    default_auto_field: str = "velox.db.fields.AutoField"
...
class AppRegistry:
    """
    Registry for managing Velox applications.
