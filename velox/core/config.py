"""
Configuration management for Velox framework
...
class Settings(BaseSettings):
    """
    Main settings class for Velox applications.
    ...
    # Application info
    APP_NAME: str = Field(default="Velox Application", description="Application name")
    APP_VERSION: str = Field(default="1.0.0", description="Application version")
    APP_DESCRIPTION: str = Field(default="Built with Velox Framework", description="Application description")
    ...
    CACHE_KEY_PREFIX: str = Field(default="velox:", description="Cache key prefix")
    ...
    INSTALLED_APPS: List[str] = Field(
        ...
        description="List of installed Velox apps"
    )
