"""
Middleware system for Velox framework.
...
class Middleware:
    """
    Base middleware class for Velox framework.
...
class MiddlewareAdapter(BaseHTTPMiddleware):
    """
    Adapter to convert Velox middleware to Starlette middleware.
    """
...
class ErrorHandlerMiddleware(Middleware):
    ...
    async def process_exception(self, request: Request, exc: Exception) -> Response:
        """Handle exceptions."""
        from velox.http.responses import JsonResponse, ErrorResponse
...
class MiddlewareStack:
    ...
    def build(self) -> List:
        ...
        for middleware_class, kwargs in self.middleware:
            # Convert Velox middleware to Starlette middleware
