"""
HTTP controllers for Velox framework.
...
from velox.core.container import inject
from velox.core.exceptions import ValidationError, NotFoundError
from velox.http.responses import JsonResponse, TemplateResponse, ErrorResponse
...
class ViewController(Controller):
    ...
    def redirect(self, url: str, status_code: int = 302):
        ...
        from velox.http.responses import RedirectResponse
