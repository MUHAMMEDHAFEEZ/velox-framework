"""
HTTP responses for Velox framework.
...
class JsonResponse(StarletteJSONResponse):
    ...
    Example:
        ```python
        from velox.http.responses import JsonResponse
...
class TemplateResponse(HTMLResponse):
    ...
    Example:
        ```python
        from velox.http.responses import TemplateResponse
...
class FileResponse(StarletteFileResponse):
    ...
    Example:
        ```python
        from velox.http.responses import FileResponse
...
class StreamingJsonResponse(StreamingResponse):
    ...
    Example:
        ```python
        from velox.http.responses import StreamingJsonResponse
...
class ErrorResponse(JsonResponse):
    ...
    Example:
        ```python
        from velox.http.responses import ErrorResponse
...
class SuccessResponse(JsonResponse):
    ...
    Example:
        ```python
        from velox.http.responses import SuccessResponse
...
class NoContentResponse(Response):
    ...
    Example:
        ```python
        from velox.http.responses import NoContentResponse
